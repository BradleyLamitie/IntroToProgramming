 ...
 function check_win(){
	...
	if(num0 ==  num1 && num1 ==  num2 &&num2 == num3 && num3== num4 && num1 == player){ 
    		...
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num10 ==  num11 && num11 ==  num12 &&num12 == num13 && num13== num14 && num10 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num15 ==  num16 && num16 ==  num17 &&num17 == num18 && num18== num19 && num15 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num20 ==  num21 && num21 ==  num22 &&num22 == num23 && num23== num24 && num21 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num0 ==  num5 && num5 ==  num10 &&num10 == num15 && num15== num20 && num10 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num1 ==  num6 && num6 ==  num11 &&num11 == num16 && num16== num21 && num21 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num2 ==  num7 && num7 ==  num12 &&num12 == num17 && num17== num22 && num22 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num3 ==  num8 && num8 ==  num13 &&num13 == num18 && num18== num23 && num23 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num4 ==  num9 && num9 ==  num14 &&num14 == num19 && num19== num24 && num24 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num0 ==  num6 && num6 ==  num12 &&num12 == num18 && num18== num24 && num24 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else if(num4 ==  num8 && num8 ==  num12 &&num12 == num16 && num16== num20 && num20 == player){ 
    		alert("You win! The winner is "+ player);
			document.getElementById("sam").innerHTML = "Victory Song (Victorious by Patd!)"; //check if win has been achieved for this set of #s
  	}else{
